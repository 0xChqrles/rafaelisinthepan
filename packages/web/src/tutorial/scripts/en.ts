...
// the secret), so the activation is always seen before the solve. The bot's FIVE tries
...
// FREEDOM fills it — visibly — and the given words land; a failed try then earns the hint,
// never the word.
//
