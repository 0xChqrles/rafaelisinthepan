...
export default function FriendInvite({ publicId, lang }: { publicId: string; lang: string }) {
  ...
  // The PERSON and what you can do about them: their mark and name directly over ADD
  // FRIEND, and PLAY under it as the way out for a reader who wants the game and not the
  // friend (user-decided 2026-09-05: a landing with one door is a wall).
  return (
