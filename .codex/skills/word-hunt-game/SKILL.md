---
name: word-hunt-game
description: Build, modify, and validate the Word Hunt React/Vite game in this repository. Use when Codex works on the game UI, `public/game_data.json`, dataset generation, ranking semantics, scoring, language selection, timer/input loop, flat pixel styling, or regression checks for the word-hole gameplay.
---
...
```bash
node .codex/skills/word-hunt-game/scripts/validate_game_data.mjs public/game_data.json
```
