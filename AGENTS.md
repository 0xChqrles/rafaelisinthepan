...
pnpm puzzle:inventory [--s3] [--days N] [--langs en,fr] [--fail-on-gap]  # publish-buffer coverage (#61); reports + exits 0 by default, --fail-on-gap exits 1 on any (day,lang) gap for cron/CI
